...
# Basis-Metadaten
{{type|Art der Metadaten (z.B. video, audio, article)}}
{{created|Erstellungszeitpunkt (ISO 8601)}}
{{modified|Letzter Änderungszeitpunkt (ISO 8601)}}
...
{{temporal_start|Beginn des behandelten Zeitraums}}
{{temporal_end|Ende des behandelten Zeitraums}}
{{temporal_period|Bezeichnung der Periode (z.B. "Holozän")}}
{{spatial_location|Ortsname}}
{{spatial_latitude|Geografische Breite}}
{{spatial_longitude|Geografische Länge}}
{{spatial_habitat|Lebensraum/Biotop}}
{{spatial_region|Region/Gebiet}}
...
{{resource_type|Art der Ressource (z.B. "Book", "Video", "Audio")}}
{{resource_format|Physisches/digitales Format}}
{{resource_extent|Umfang (z.B. "342 Seiten", "45 Minuten")}}

# Quellenangaben
{{source_title|Titel der Quelle}}
{{source_type|Art der Quelle}}
{{source_identifier|Eindeutige Kennung der Quelle}}

# Digitale Plattform
{{platform_type|Art der Plattform (z.B. "youtube", "vimeo")}}
{{platform_url|URL zur Ressource}}
...
{{social_metrics_likes|Anzahl der Likes}}
...
# Verwaltung
{{collection|Zugehörige Sammlung}}
{{archival_number|Archivnummer}}
