...
async def test_transformer_story():
    ...
    try:
        ...
        template_path_de = "templates/Story_de.md"
        template_path_base = "templates/Story.md"
        
        # Story_de.md Template erstellen
        if not os.path.exists(template_path_de):
            with open(template_path_de, "w", encoding="utf-8") as f:
                f.write("""---
...
""")
        ...
        # Auch Story.md Template erstellen (gleicher Inhalt)
        # Der TransformerProcessor sucht nach diesem Template
        if not os.path.exists(template_path_base):
            with open(template_path_base, "w", encoding="utf-8") as f:
                f.write("""---
title: "{{topic_display_name}}"
tags: {{tags}}
---
